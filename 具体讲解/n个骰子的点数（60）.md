# 1. 问题描述
- 把 `n` 个骰子扔在地上，所有骰子朝上1面的点数之和为 `s`
- 输入 `n` ，打印出 `s` 的所有可能的值的出现概率。
***
# 2. 考察点
- 数学建模能力
- 递归、循环的性能的理解
...
![示意图](http://upload-images.jianshu.io/upload_images/944365-cec9100ebc1558be.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


- 根据核心思路，本题具备2种解题方法

![示意图](http://upload-images.jianshu.io/upload_images/944365-9c3190eb261da2f9.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
***
# 5. Demo地址
[Carson_Ho的Github地址：面试60 - n个骰子的点数](https://github.com/Carson-Ho/AlgorithmLearning)